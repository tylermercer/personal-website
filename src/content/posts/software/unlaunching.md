...
[^profession]: It’s worth noting here that although I am a software engineer by profession, I don’t experience this kind of cognitive narrowing, or the close-resistance described earlier, with my professional work. There are a few reasons for this, but I think the most significant reasons are (1) the highly collaborative nature of work, (2) the difference in complexity between my work codebase and my projects, and (3) the fact that I and my employer are incentivized to keep a clean separation between my work and the rest of my life. 
	...
	Working in a team imposes a helpful limit on my cognitive absorption in my work. I fill the role of engineer, while the UX designer, product manager, and user roles are external to myself. This puts a limit on how fast the thinking side of the work can occur, because it involves comparatively slow person-to-person communication.
	
	In a side project, on the other hand, I fill all those roles at once. I can use the app, have ideas for how it could be improved, design and architect that future improvement, think of several other features that that improvement unlocks, design and architect _those_ features, etc.---effectively forever. I am never blocked needing approval for an idea or a review on my code.

	This collaboration at work is necessary, since what I work on at work is much more complex than my side projects. This difference of complexity also impacts the absorption I experience: with a side project, I more or less contain the entire structure in my head, because I have built every part of it. But at work, our codebase is so extensive that I can only meaningfully wrap my head around the specific parts I’m using in my work. Parts of the codebase that I am not actively working on---even ones I understand well---will diverge from my mental model over time, since other people will modify that code. This, again, imposes a limit on how "far" I can think about a given idea, even if I were to (unwisely) assume all the roles described above in my thinking.

	Finally, I typically try to maintain a strict separation between my work life and my home life. Once I leave work, I tend not to check Slack or my work email. If thoughts about work projects come up outside work hours, I write them down to consider the next day. Between writing them down and the collaborative nature of my work described previously, I’m able to close these loops pretty quickly.
