...
import faustina from '@fontsource/faustina/files/faustina-latin-ext-400-normal.woff';
import figtree from '@fontsource/figtree/files/figtree-latin-ext-400-normal.woff';
...
export const GET: APIRoute = async ({ params }) => {
    ...
    const svg = await satori(renderHtml(entry, category), {
        width: 1200,
        height: 630,
        fonts: [
            {
